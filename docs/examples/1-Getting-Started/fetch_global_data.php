...
namespace VRPayment\Example;

/**
 * Global Data Example
 *
 * Reads every global reference list the VRPayment Portal exposes through the single
 ...
 *   the concrete IETF variant the VRPayment Portal expects.
 * - CurrencyRoundingService::round() to round an amount to the decimal places
 *   the currency actually uses.
 *
 * None of these lookups is space-scoped: this is data about the VRPayment Portal itself,
...
use VRPayment\PluginCore\Examples\Common\EnvSettingsProvider;
use VRPayment\PluginCore\Examples\Common\SimpleLogger;
...
try {
    ...
    // A shop usually stores 'en'; the VRPayment Portal expects a concrete variant such as
