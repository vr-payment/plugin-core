 ...
 *
 * NOTE: An indication only exists once the payment is captured AND the VRPayment Portal
...
use VRPayment\PluginCore\DeliveryIndication\DeliveryIndicationService;
