...
// Install the webhook configuration (URL and Listener) in the VRPayment Portal.
...
// Deleting only the listeners would leave the URL registered in the VRPayment Portal,
