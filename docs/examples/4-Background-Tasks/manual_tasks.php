...
use VRPayment\PluginCore\ManualTask\ManualTaskService;
...
try {
    ...
    if ($total === 0) {
        ...
        echo PHP_EOL
            . "Zero manual tasks reported. If the VRPayment Portal lists some," . PHP_EOL
            ...
            . "  2. Space — the VRPayment Portal view may be scoped to a" . PHP_EOL
