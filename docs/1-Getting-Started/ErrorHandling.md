...
`TransientWebhookException` — used when processing incoming webhooks — is always retryable, matching the VRPayment Portal's own webhook retry behavior.
