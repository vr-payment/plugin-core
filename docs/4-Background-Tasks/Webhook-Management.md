...
The Webhook Management module allows developers to programmatically manage webhook subscriptions in the VRPayment Portal and validate incoming payloads.

## Overview

A webhook consists of two parts in the VRPayment Portal:

1. **Webhook URL**: The endpoint where the VRPayment Portal will send notifications.
