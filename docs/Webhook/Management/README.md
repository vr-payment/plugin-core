...
$config = new WebhookConfig(
    ...
    entityId: \VRPayment\PluginCore\Webhook\Enum\WebhookListener::TRANSACTION->value,
    eventStateId: \VRPayment\PluginCore\Transaction\State::AUTHORIZED->value
);
...
$webhookService->uninstallWebhook(
    $spaceId,
    $webhookUrlId,
    \VRPayment\PluginCore\Webhook\Enum\WebhookListener::TRANSACTION->value,
    \VRPayment\PluginCore\Transaction\State::AUTHORIZED->value
);
```
