...
namespace VRPayment\PluginCore\GlobalData\PaymentConnector;

use VRPayment\PluginCore\Localization\LocalizedString;
use VRPayment\PluginCore\SharedKernel\JsonStringableTrait;

/**
 * Value Object representing one payment connector the VRPayment Portal defines.
 *
 ...
 * {@see \VRPayment\PluginCore\Transaction\TransactionPaymentMethod::$connectorId}
 * and {@see \VRPayment\PluginCore\Token\TokenVersion::$connectorId}.
 *
