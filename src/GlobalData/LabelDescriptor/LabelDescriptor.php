...
namespace VRPayment\PluginCore\GlobalData\LabelDescriptor;

use VRPayment\PluginCore\Localization\LocalizedString;
use VRPayment\PluginCore\SharedKernel\JsonStringableTrait;

/**
 * Value Object representing one label descriptor the VRPayment Portal defines.
 *
 ...
 * it is what a {@see \VRPayment\PluginCore\Charge\Attempt\Label}'s
 ...
 * {@see \VRPayment\PluginCore\Charge\Attempt\ChargeAttempt::getLabel()}'s
 * job.
 *
 ...
 * {@see \VRPayment\PluginCore\LabelDescriptorGroup\LabelDescriptorGroup}.
 ...
 * {@see \VRPayment\PluginCore\GlobalData\GlobalDataService}
 * with this ID.
 */
readonly class LabelDescriptor
{
     ...
     *        {@see \VRPayment\PluginCore\Charge\Attempt\Label::$descriptorId}
     *        refers to.
