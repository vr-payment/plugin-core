...
/**
 * Domain-facing facade for the VRPayment Portal's global reference data.
 *
 ...
 *
 * None of these methods take a space ID — this data is global to the VRPayment Portal, not
