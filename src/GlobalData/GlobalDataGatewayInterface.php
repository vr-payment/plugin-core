...
namespace VRPayment\PluginCore\GlobalData;
...
/**
 * Read access to the VRPayment Portal's global reference data.
 *
 * These lists describe what the VRPayment Portal itself supports — the currencies and
...
{
    /**
     * Returns every currency the VRPayment Portal supports.
     *
    ...
    /**
     * Returns every label descriptor group the VRPayment Portal defines.
     *
    ...
    /**
     * Returns every label descriptor the VRPayment Portal defines.
     *
     * A label descriptor is the definition of a kind of label; it is what a
     * {@see \VRPayment\PluginCore\Charge\Attempt\Label}'s `descriptorId`
     * refers to.
     *
    ...
    /**
     * Returns every language the VRPayment Portal supports.
     *
    ...
    /**
     * Returns every payment connector the VRPayment Portal defines.
     *
