...
namespace VRPayment\PluginCore\GlobalData\Currency;

use VRPayment\PluginCore\SharedKernel\JsonStringableTrait;

/**
 * Value Object representing one currency the VRPayment Portal supports.
 *
 ...
 * validating a shop's configured currency against what the VRPayment Portal accepts.
 *
...
readonly class Currency
{
     ...
     *        (e.g. 'BHD') use 3 — see {@see \VRPayment\PluginCore\GlobalData\Currency\CurrencyRoundingService}
