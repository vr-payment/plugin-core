...
class Settings
{
    ...
    public function getApiKey(): string
    {
        ...
        if (empty($value)) {
            throw new \InvalidArgumentException('VRPayment API Key is missing or invalid.');
        }
        return (string) $value;
    }
    ...
    public function getSpaceId(): int
    {
        ...
        if (empty($value)) {
            throw new \InvalidArgumentException('VRPayment Space ID is missing or invalid.');
        }
        return (int) $value;
    }
    ...
    public function getUserId(): int
    {
        ...
        if (empty($value)) {
            throw new \InvalidArgumentException('VRPayment User ID is missing or invalid.');
        }
        return (int) $value;
    }
