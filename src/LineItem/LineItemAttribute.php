...
use VRPayment\PluginCore\SharedKernel\StringSanitizer;

/**
 * Custom attribute attached to a {@see LineItem}.
 *
 * The VRPayment Portal renders attributes as `label: value` pairs (e.g. "Size: M"), so
...
class LineItemAttribute
{
    ...
    /**
     * @param string $id VRPayment Portal-side attribute identifier (e.g. "option_144"),
