...
use VRPayment\Sdk\Service\DeliveryIndicationsService;
use VRPayment\Sdk\Service\ManualTasksService;
...
use VRPayment\Sdk\Service\TransactionInvoicesService;
use VRPayment\Sdk\Service\TransactionsService;
use VRPayment\Sdk\Service\TransactionVoidsService;
...
class DefaultStateFetcher implements StateFetcherInterface
{
    ...
    /**
     * Helper to dynamically fetch the remote state from the VRPayment Portal API.
     *
