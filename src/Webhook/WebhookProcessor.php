...
class WebhookProcessor
{
    ...
    /**
     * Processes an incoming webhook request from the VRPayment Portal.
     *
    ...
    public function process(Request $request): void
    {
        ...
        try {
            ...
            // 5xx and the VRPayment Portal retries the delivery.
            ...
            // that it should return a 5xx error. This instructs the VRPayment Portal to
