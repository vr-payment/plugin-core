 ...
 *
 * Defines the contract for managing webhook URLs and listeners in the VRPayment Portal.
 */
interface WebhookManagementGatewayInterface
{
    /**
    ...
    /**
     * Creates a webhook URL definition in the VRPayment Portal.
     *
    ...
    /**
     * Lists webhook listeners in the VRPayment Portal.
     *
     * @param int $spaceId
     * @return WebhookListenerCollection
     */
    ...
    /**
     * Lists webhook URL definitions in the VRPayment Portal.
     *
     * @param int $spaceId
     * @return WebhookUrlCollection
     */
