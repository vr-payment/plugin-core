 ...
 *
 * A token is the VRPayment Portal's reference to a customer's stored payment credentials.
 * It is the long-lived handle a plugin keeps against a customer; the credentials
 * themselves live in the VRPayment Portal and are never exposed here.
 *
...
readonly class Token
{
     ...
     *        by the VRPayment Portal. This is the key to filter by when listing one customer's
