 ...
 *   {@see \VRPayment\PluginCore\GlobalData\PaymentConnector} lists.
 ...
 * {@see \VRPayment\PluginCore\PaymentMethod\PaymentMethod::$id} is a
...
readonly class TokenVersion
{
     ...
     *        the VRPayment Portal, or null when the API reported none.
     ...
     *        {@see \VRPayment\PluginCore\PaymentMethod\PaymentMethod::$id},
