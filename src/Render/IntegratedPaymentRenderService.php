...
<script{$nonceAttr}>
    window.__vrpaymentHandlers = window.__vrpaymentHandlers || {};
HTML;
    ...
    window.__vrpaymentHandlers['{$data->paymentMethodConfigurationId}'] = handler;
...
HTML;
    ...
    window.__vrpaymentHandlers['{$data->paymentMethodConfigurationId}'] = window.LightboxCheckoutHandler;
