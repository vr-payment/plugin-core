...
enum State: string
{
     ...
     *
     * While AUTHORIZED, the VRPayment Portal has not generated its own invoice yet, so
     * the shop's local bookkeeping can still freely create or cancel one.
     * Once COMPLETED, the VRPayment Portal's invoice takes over and local manipulation
     * is no longer safe.
     */
    ...
    /**
     * Whether the VRPayment Portal has generated an invoice document that can be downloaded.
     *
    ...
    /**
     * Whether the VRPayment Portal has generated a packing slip that can be downloaded.
     *
     ...
     * whether the VRPayment Portal has invoiced or fulfilled the order yet.
     */
