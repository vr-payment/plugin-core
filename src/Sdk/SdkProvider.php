...
class SdkProvider
{
     ...
     *        shop system and plugin to the VRPayment Portal. Optional: without one, calls carry no
     ...
     * reads non-space-scoped data — the VRPayment Portal's global reference data, say — can
     ...
     *
     * A connection error means the request never reached the VRPayment
     * VRPayment Portal: nothing was processed, so replaying it is safe and is expected to
