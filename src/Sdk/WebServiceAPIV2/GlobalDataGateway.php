...
use VRPayment\PluginCore\Sdk\CurrencyMapperTrait;
use VRPayment\PluginCore\Sdk\LabelDescriptorGroupMapperTrait;
use VRPayment\PluginCore\Sdk\LabelDescriptorMapperTrait;
use VRPayment\PluginCore\Sdk\LanguageMapperTrait;
use VRPayment\PluginCore\Sdk\PaymentConnectorMapperTrait;
use VRPayment\PluginCore\Sdk\SdkProvider;
use VRPayment\PluginCore\Sdk\SearchPaginationTrait;
use VRPayment\Sdk\Model\CurrencyListResponse as SdkCurrencyListResponse;
use VRPayment\Sdk\Model\LabelDescriptor as SdkLabelDescriptor;
use VRPayment\Sdk\Model\LabelDescriptorGroup as SdkLabelDescriptorGroup;
use VRPayment\Sdk\Model\LabelDescriptorGroupSearchResponse as SdkLabelDescriptorGroupSearchResponse;
use VRPayment\Sdk\Model\LabelDescriptorSearchResponse as SdkLabelDescriptorSearchResponse;
use VRPayment\Sdk\Model\LanguageListResponse as SdkLanguageListResponse;
use VRPayment\Sdk\Model\PaymentConnector as SdkPaymentConnector;
use VRPayment\Sdk\Model\PaymentConnectorSearchResponse as SdkPaymentConnectorSearchResponse;
use VRPayment\Sdk\Model\RestApiErrorResponse as SdkRestApiErrorResponse;
use VRPayment\Sdk\Model\RestCurrency as SdkRestCurrency;
use VRPayment\Sdk\Model\RestLanguage as SdkRestLanguage;
use VRPayment\Sdk\Service\CurrenciesService as SdkCurrenciesService;
use VRPayment\Sdk\Service\LabelDescriptorsService as SdkLabelDescriptorsService;
use VRPayment\Sdk\Service\LanguagesService as SdkLanguagesService;
use VRPayment\Sdk\Service\PaymentConnectorsService as SdkPaymentConnectorsService;

/**
 * Gateway for retrieving the VRPayment Portal's global reference data using the SDK.
 *
 * This data is global to the VRPayment Portal, so no call here is space-scoped. Unlike most
