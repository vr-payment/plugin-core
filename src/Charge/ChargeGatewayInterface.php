...
namespace VRPayment\PluginCore\Charge;

use VRPayment\PluginCore\Charge\Attempt\ChargeAttempt;
use VRPayment\PluginCore\Charge\Attempt\Label;
...
interface ChargeGatewayInterface
{
     ...
     *
     * This is a command, not a query: it asks the VRPayment Portal to process the transaction
