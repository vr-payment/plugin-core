...
class PaymentMethodTest extends TestCase
{
    ...
    {
        $method = $this->createMethodWithImageUrl('https://gateway.vr-payment.de/s/123/resource/payment/icon.svg');
    ...
    {
        $method = $this->createMethodWithImageUrl('https://gateway.vr-payment.de/images/icon.svg');

        $this->assertSame('https://gateway.vr-payment.de/images/icon.svg', $method->getRelativeImagePath());
    }
    ...
    {
        $method = $this->createMethodWithImageUrl('https://gateway.vr-payment.de/s/123/resource/payment/twint.svg?strategy=snapshot');
