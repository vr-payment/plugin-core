...
use VRPayment\Sdk\Model\PaymentMethodConfiguration as SdkConfiguration;
...
class TransactionGatewayTest extends TestCase
{
    ...
    public function testFetchAvailablePaymentMethodsUsesSettingsMode(): void
    {
        ...
        $sdkItem->setState(\VRPayment\Sdk\Model\CreationEntityState::ACTIVE);
    ...
    public function testFetchPaymentMethodConfigurationsMapsCorrectly(): void
    {
        ...
        $sdkItem1->setState(\VRPayment\Sdk\Model\CreationEntityState::ACTIVE);
