...
namespace VRPayment\PluginCore\Tests\Render;

use PHPUnit\Framework\TestCase;
use VRPayment\PluginCore\Render\IntegratedPaymentRenderService;
use VRPayment\PluginCore\Render\PaymentIntegrationData;
...
class IntegratedPaymentRenderServiceTest extends TestCase
{
    ...
    public function testRenderHtmlIframe(): void
    {
        ...
        $this->assertStringContainsString('window.__vrpaymentHandlers = window.__vrpaymentHandlers || {};', $html);
        $this->assertStringContainsString("window.__vrpaymentHandlers['456'] = handler;", $html);
    ...
    public function testRenderHtmlLightbox(): void
    {
        ...
        $this->assertStringContainsString('window.__vrpaymentHandlers = window.__vrpaymentHandlers || {};', $html);
        $this->assertStringContainsString("window.__vrpaymentHandlers['789'] = window.LightboxCheckoutHandler;", $html);
    }
    ...
    public function testRenderJsWithNonce(): void
    {
        ...
        $this->assertStringContainsString('window.__vrpaymentHandlers', $js);
